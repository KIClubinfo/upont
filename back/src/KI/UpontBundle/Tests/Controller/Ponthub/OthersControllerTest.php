...
class OthersControllerTest extends WebTestCase
{
    ...
    {
        $this->client->request('PATCH', '/others/windows-vista', array('image' => 'http://upload.wikimedia.org/wikipedia/commons/5/5a/Wikipedia-logo-v2-fr.png', 'description' => 'De la daube...', 'tags' => array(array('name' => 'windaube'), array('name' => 'vista'))));
        $response = $this->client->getResponse();
