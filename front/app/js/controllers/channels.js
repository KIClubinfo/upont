    ...
    .config(['$stateProvider', function ($stateProvider){
        $stateProvider
            .state("channels", {
                ...
                data : {parent : "channels", defaultChild: "liste"}
            })
            ...
            .state("channels.simple", {
                ...
                data : { toParent : true, parent : "channels.simple", defaultChild: "publications" },
                resolve : {
                    channel : ["$resource", "$stateParams", function($resource, $stateParams){
                        return $resource(apiPrefix+"clubs/:slug").get({slug : $stateParams.slug}).$promise;
                    }]
                },
