angular.module('upont')
    ...
    .config(['$stateProvider', function($stateProvider) {
        $stateProvider
            .state("root.zone_eleves.ponthub", {
                url: "ponthub/:category",
                templateUrl: "views/zone_eleves/ponthub/index.html",
                abstract: true,
                data: {
                    title: 'PontHub - uPont',
                    top: true
            ...
            .state("root.zone_eleves.ponthub.simple", {
                url: "/:slug",
                templateUrl: "views/zone_eleves/ponthub/simple.html",
            ...
            .state("root.zone_eleves.ponthub.modify", {
                url: "/:slug/rangement",
                templateUrl: "views/zone_eleves/ponthub/modify.html",
