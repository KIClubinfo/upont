...
class Tour_Ctrl {
    constructor($scope, $rootScope, $http, $sce, $state, Achievements) {
        const steps = [
            {
                ...
                icon: 'sign-in',
                text: '<strong>Bienvenue sur uPont !</strong><br>' + 'Que tu sois nouveau.elle ou déjà vieux con, cet intranet déborde tellement de fonctionnalités que le KI te propose d\'en faire le tour de façon interactive !<br>' + 'Une surprise t\'attend même à la fin <i class="fa fa-smile-o"></i>',
            }, {
                state: 'root.users.publications.list',
                icon: 'star',
                text: 'Comme tu as pu le remarquer, ce site est doté d\'un système d\'<strong>achievements.</strong><br>' + 'Tu as dû gagner le premier d\'entre eux en te connectant ! D\'autres arriveront certainement tout au long de ce tour.<br>' + 'Note aussi la <strong>barre de recherche</strong> en haut à gauche, elle est <strong>ultra-efficace !</strong>',
            }, {
                state: 'root.users.publications.list',
                icon: 'pencil',
                ...
                params: {
                    slug: $rootScope.username,
                },
                icon: 'user',
                text: 'Je te propose de modifier ton profil afin de partir du bon pied.<br>' + '<strong>Avoir des infos à jour est super important</strong>, si tout le monde les remplit tu pourras profiter au max des fonctionnalités de uPont comme la <strong>synchronisation des contacts</strong> ou le <strong>jeu de la Réponse D !</strong>',
            }, {
                state: 'root.users.students.modify',
                params: {
                    slug: $rootScope.username,
                ...
                icon: 'calendar',
                text: 'Accessoirement, sur cette page tu peux aussi synchroniser le calendrier uPont avec ton Mac/iBidule/Thunderbird/etc.<br>' + '<strong>Attends ? Quel calendrier ? ...</strong>',
            }, {
                state: 'root.users.calendar',
                icon: 'calendar',
                text: 'Le calendrier contient <strong>tous les événements des clubs que tu suis</strong> mais aussi tes cours !<br>' + '<strong>Quoi ? Il est synchronisé avec mes cours ?</strong>',
            }, {
                state: 'root.users.resources.courses.list',
                icon: 'graduation-cap',
                text: 'En effet ! C\'est ici que tu as la liste des cours et que <strong>tu peux choisir ceux que tu suis !</strong><br>' + 'Par exemple, essaye de suivre un cours en cliquant sur le symbole <i class="fa fa-eye"></i>. Il sera <strong>automatiquement ajouté au calendrier</strong> dès qu\'il y aura une prochaine séance de ce cours !',
            }, {
                state: 'root.users.resources.courses.list',
                icon: 'graduation-cap',
                ...
                icon: 'arrow-down',
                text: 'Mais attends ! <strong>Tu peux télécharger autre chose que le dernier exam de strat fi !</strong><br>' + 'Ceci est PontHub (prononcer [Pont\'teub]), l\'endroit où tu viendras télécharger toutes les séries et derniers films de vacances !<br>' + 'Attention, <strong>ce service n\'est accessible que depuis les résidences...</strong>',
            }, {
                state: 'root.users.students.game',
                icon: 'gamepad',
                text: 'Si tu cherches une autre façon de te distraire, il y a <strong>la Réponse D !</strong><br>' + 'Dans ce jeu qui poussera ta mémoire dans ses derniers retranchements, tu devras retrouver qui est qui...<br>' + '<strong>Essaye une ou deux parties pour voir !</strong>',
            }, {
                ...
                icon: 'beer',
                text: 'En parlant de Foyer, tu pourras trouver le <strong>Hall Of Fame des plus gros buveurs</strong> sur cette page.<br>' + 'Si ça te chante, tu peux même <strong>ajouter le dernier clip de Booba pour qu\'il soit passé au prochain Foyer !</strong>',
            }, {
                ...
                icon: 'smile-o',
                text: 'Et voilà, c\'est fini ! Enfin, <strong>ce n\'est que le début</strong>...<br>' + 'uPont est encore en développement, <strong>n\'oublie pas de partager tes idées !</strong><br>' + 'Comme promis, clique encore une fois la flèche suivante et tu auras un cadeau bien mérité...',
            },
        ];
        ...
        $scope.loadStep = function(step) {
            $state.go(steps[step].state, steps[step].params).then(() => {
                $scope.step = step;
